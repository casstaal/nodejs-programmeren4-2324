...
const INSERT_USER =
    ...
    '(3, "first", "last", 0, "name3@server.nl", "secret", "street", "city");'
...
describe('UC206 Verwijderen van user', () => {
    ...
    describe('UC206 Verwijderen van user', () => {
        ...
        //Als ik de call in postman doe krijg ik de status 404. Als ik hem hier doe krijg ik 200, maar als ik dan in expect.status 200 zet krijg ik wel opeens 404
        //De status die ik krijg wordt dus steeds omgedraaid
        ...
        //Als ik de call in postman doe krijg ik de status 403. Als ik hem hier doe krijg ik 200, maar als ik dan in expect.status 200 zet krijg ik wel opeens 403
        //De status die ik krijg wordt dus steeds omgedraaid
        ...
        it('TC-206-4 Gebruiker succesvol verwijderd', (done) => {
            ...
            chai.request(server)
                ...
                .end((err, res) => {
                    ...
                    chai.expect(res.body)
                        .to.have.property('message')
                        .equals('User met ID 1 is verwijderd.')
                    chai
                        .expect(res.body)
                        .to.have.property('data')
                        .that.is.a('object').that.is.empty
